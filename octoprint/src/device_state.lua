...
function JobInfo.all()
  return {
    file = "",
    percent_complete = 0,
    time_remaining = TimeRemaining.all()
  }
end


function TimeRemaining.all()
  return {
    hours = 0,
    minutes = 0,
    seconds = 0
...
---@class DeviceState
---@field public switch SwitchState|nil
---@field public job JobInfo|nil
---@field public bed TempState|nil
---@field public tool TempState|nil
local DeviceState = {}
